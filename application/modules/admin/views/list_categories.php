                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX" id="tr_<?php echo $count;?>">
                                ...
                                <td class="center">
                                    ...
                                    <a href="javascript:void(0)" onclick="delete_record('<?php echo $value->id?>','<?php echo $count;?>','category')"><i class="fa fa-trash-o" aria-hidden="true"></i></a> |
                                    <a title="Change Status" href="javascript:void(0)" onclick="change_status('<?php echo $value->id?>','category','<?php echo $value->is_active?>')"><i class="fa fa-power-off" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                            <?php $count++; }}?>
                        </tbody>
