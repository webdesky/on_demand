<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Sub Categories List </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- row -->
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a class="btn btn-primary" href="<?php echo base_url('admin/sub_categories')?>"><i class="fa fa-th-list">&nbsp;Add Sub Categories </i></a>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    ...
                    <table class="table table-striped table-bordered display nowrap" cellspacing="0" width="100%" id="notice">
                        ...
                        <tbody>
                            <?php $count=1; if(!empty($sub_categories)) {  foreach ($sub_categories as  $value) {?>
