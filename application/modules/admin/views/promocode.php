                            ...
                            <form role="form" method="post" action="<?php echo $url; ?>" class="registration_form1" enctype="multipart/form-data">
                                <div class="form-group"> 
                                    ...
                                    <div class="col-lg-6"> 
                                        ...
                                        <span class="red" id="old"><?php echo form_error('promo_code'); ?></span> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group"> <label class="col-md-2">Description</label>
                                    <div class="col-lg-6"> 
                                        ...
                                        <span class="red" id="new"><?php echo form_error('description'); ?></span> 
                                    </div>
                                </div>
                                <br/>
                                ...
                                <div class="form-group"> <label class="col-md-2">Discount Type *</label>
                                    <div class="col-lg-6"> 
                                        ...
                                        <span class="red" id="old"><?php echo form_error('discount_type'); ?></span> 
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group"> 
                                    ...
                                    <div class="col-lg-6"> 
                                        ...
                                        <span class="red" id="old"><?php echo form_error('discount_amount'); ?></span> 
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group"> <label class="col-md-2">Validity Type *</label>
                                    <div class="col-lg-6"> 
                                        <input type="radio" name="validity_type" id="validity_type_0" value="permanent" onclick="get_active_date()" checked="checked" <?php if(!empty($promocode[0]->validity_type)){ if($promocode[0]->validity_type=='permanent'){ echo "checked";}}else{ echo "";}?>>Permanent
                                        <input type="radio" name="validity_type" id="validity_type_1" value="custom" onclick="get_active_date()" <?php if(!empty($promocode[0]->validity_type)){ if($promocode[0]->validity_type=='custom'){ echo "checked";}}else{ echo "";}?>>Custom
                                    </div>
                                    <span class="red" id="old"><?php echo form_error('validity_type'); ?></span> 
                                </div>
                                <div class="clearfix"></div>
                                <?php 
                                ...
                                { ?>
                                    <div class="form-group" id="active_date_div" <?php if($promocode[0]->validity_type=='permanent') { echo 'style="display: none" ';}?> > <label class="col-md-2">Activation Date *</label>
                                        <div class="col-lg-6"> 
                                             <input class="form-control" type="text" placeholder="Activation Date" name="active_date" autocomplete="off" id="active_date"  value="<?php if(!empty($promocode[0]->active_date)){ echo $promocode[0]->active_date;}else{ echo set_value('active_date');} ?>">
                                        </div>
                                        <span class="red" id="old"><?php echo form_error('active_date'); ?></span> 
                                    </div>
                                    <div class="clearfix"></div>
                                    <div class="form-group" id="expiry_date_div" <?php if($promocode[0]->validity_type=='permanent') { echo 'style="display: none" ';}?>> <label class="col-md-2">Expiry Date *</label>
                                        <div class="col-lg-6"> 
                                             <input class="form-control" type="text" placeholder="Expiry Date" name="expiry_date" autocomplete="off" id="expiry_date"  value="<?php if(!empty($promocode[0]->expiry_date)){ echo $promocode[0]->expiry_date;}else{ echo set_value('expiry_date');} ?>">
                                        </div>
                                        <span class="red" id="old"><?php echo form_error('expiry_date'); ?></span> 
                                    </div>
                                    <div class="clearfix"></div>
                                <?php
                                }
                                ...
                                <div class="form-group"> <label class="col-md-2">Usage Limit *</label>
                                    ...
                                    <span class="red" id="old"><?php echo form_error('usage_limit'); ?></span> </div>
                                </div>
